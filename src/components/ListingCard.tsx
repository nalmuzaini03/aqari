  ...
  return (
    <Link href={`/listings/${l.id}`} className="group block overflow-hidden" style={{ borderRadius: "16px", border: "1px solid #EBEBEB", background: "white", transition: "box-shadow 0.2s" }}>
      <div className="relative" style={{ height: "200px", background: "#F7F7F7" }}>
        ...
        <span style={{
          background: l.listing_type === "rent" ? "#FF385C" : "#222",
          color: "white", fontSize: "11px", letterSpacing: "0.5px", fontWeight: 600,
        ...
        {l.is_verified && (
          <span style={{
            background: "white", color: "#222", fontSize: "11px", fontWeight: 600,
            position: "absolute", top: "12px", right: "12px",
            padding: "4px 10px", borderRadius: "6px", border: "1px solid #EBEBEB",
          }}>
            ✓ Verified
          </span>
        )}
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-2 mb-1">
          <p style={{ fontSize: "15px", fontWeight: 700, color: "#222" }} className="truncate">{l.title}</p>
        </div>
        ...
        <p style={{ fontSize: "16px", fontWeight: 700, color: "#222" }}>
          {l.price.toLocaleString()} KWD
          {l.listing_type === "rent" && <span style={{ fontSize: "13px", fontWeight: 400, color: "#717171" }}> / month</span>}
        </p>
      </div>
    </Link>
  )
