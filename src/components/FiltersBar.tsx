      ...
      <div style={{ background: "white", borderBottom: "1px solid #EBEBEB" }} className="sticky top-0 z-10 px-4 sm:px-6 py-3">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <a href="/login" style={{ background: "#FF385C", color: "white", border: "none", fontSize: "13px", borderRadius: "24px", padding: "7px 16px", fontWeight: 600, whiteSpace: "nowrap" as const, textDecoration: "none" }}>+ Post</a>
          </div>
