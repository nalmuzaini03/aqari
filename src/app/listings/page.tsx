    ...
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: "white" }}>
      ...
      <section style={{ background: "linear-gradient(180deg, #FFF0F2 0%, #FFFFFF 100%)", padding: "72px 40px 56px", textAlign: "center" }}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
          ...
          <Link href="/login" style={{ background: "white", color: "#222", border: "2px solid #DDDDDD", borderRadius: "12px", padding: "16px 32px", fontSize: "16px", fontWeight: 600, textAlign: "center" }}>
            Post a listing — free
          </Link>
        </div>
        ...
        <div style={{ background: "white", borderRadius: "16px", border: "1px solid #DDDDDD", display: "flex", overflow: "hidden", maxWidth: "900px", margin: "0 auto 48px", boxShadow: "0 2px 16px rgba(0,0,0,0.08)", flexWrap: "wrap" }}>
          {[
            { label: "GOVERNORATE", value: govFilter, options: ["All governorates", "Capital", "Hawalli", "Farwaniya", "Ahmadi", "Jahra", "Mubarak Al-Kabeer"], onChange: setGovFilter },
            { label: "AREA", value: areaFilter, options: ["Anywhere", "Salmiya", "Jabriya", "Mishref", "Hawalli", "Farwaniya", "Fahaheel"], onChange: setAreaFilter },
            { label: "TYPE", value: typeFilter, options: ["For rent or sale", "For rent", "For sale"], onChange: setTypeFilter },
            { label: "PROPERTY", value: propertyFilter, options: ["Any type", "Apartment", "Villa", "Floor", "Chalet", "Office", "Shop"], onChange: setPropertyFilter },
          ].map((f, i) => (
        ...
        <div className="flex justify-center gap-8 sm:gap-12 flex-wrap">
          {[{ num: "6", label: "Governorates" }, { num: "Free", label: "To list" }, { num: "Direct", label: "WhatsApp" }, { num: "Verified", label: "Listings" }].map((s, i) => (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3" style={{ maxWidth: "960px" }}>
          {areas.map(area => (
            <button
              ...
              style={{ background: "#FFF0F2", borderRadius: "14px", padding: "20px 16px", textAlign: "center", cursor: "pointer", border: "1.5px solid #FFD6DF", transition: "all 0.15s" }}
            >
      ...
      <section style={{ background: "linear-gradient(135deg, #FF385C 0%, #C4001B 100%)", padding: "80px 40px", textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(28px, 5vw, 40px)", fontWeight: 800, color: "white", marginBottom: "8px", letterSpacing: "-0.5px" }}>
          Ready to find your home?
        </h2>
        <p style={{ fontSize: "22px", color: "rgba(255,255,255,0.85)", marginBottom: "32px", direction: "rtl", fontWeight: 600 }}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/login" style={{ background: "transparent", color: "white", border: "2px solid rgba(255,255,255,0.5)", borderRadius: "12px", padding: "16px 32px", fontSize: "15px", fontWeight: 600, textAlign: "center" }}>
            Post a listing — free
          </Link>
        </div>
      </section>
