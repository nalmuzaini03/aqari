        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select name="bedrooms" style={{ background: "#B2F0DC", border: "1px solid #7FEDD0", color: "#0A5C46" }} className="w-full rounded-lg px-3 py-2 text-sm focus:outline-none">
                <option value="">-</option>
            ...
            <div>
              ...
              <select name="bathrooms" style={{ background: "#B2F0DC", border: "1px solid #7FEDD0", color: "#0A5C46" }} className="w-full rounded-lg px-3 py-2 text-sm focus:outline-none">
                <option value="">-</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {photos.map((file, i) => (
                    <div key={i} className="relative">
                      <img src={URL.createObjectURL(file)} alt={`preview ${i}`} className="w-full h-20 object-cover rounded-lg" />
                      <button
                        type="button"
