  ...
  return (
    <div style={{ background: "white", minHeight: "100vh" }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <h1 style={{ fontSize: "28px", fontWeight: 800, color: "#222", letterSpacing: "-0.5px" }} className="mb-1">My listings</h1>
        <p style={{ fontSize: "15px", color: "#717171" }} className="mb-8">Manage your property listings</p>
        ...
        {loading ? (
          ...
          <div style={{ border: "1px solid #EBEBEB", borderRadius: "16px" }} className="p-10 text-center">
            ...
            <p style={{ fontSize: "14px", color: "#717171" }} className="mb-6">Post your first property listing for free</p>
            ...
            {listings.map(l => (
              <div key={l.id} style={{ border: "1px solid #EBEBEB", borderRadius: "12px", padding: "16px" }} className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p style={{ fontSize: "13px", color: "#717171" }} className="mt-0.5">{l.price.toLocaleString()} KWD · {l.area}</p>
                  <span style={{ background: l.listing_type === "rent" ? "#FF385C" : "#222", color: "white", fontSize: "10px", letterSpacing: "0.5px", fontWeight: 600 }} className="inline-block mt-1.5 px-2 py-0.5 rounded uppercase">
